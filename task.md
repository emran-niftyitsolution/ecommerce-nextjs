...
> **🎨 Design Principle:** All web UI components and layouts must be modern, sleek, and follow current design trends with smooth animations and excellent user experience.

> **⚠️ Important:** Never run or build the project during development. Focus only on creating components and implementing features.
