        ...
        >
          ...
          >
            <button
              ...
              className="w-full flex items-center justify-center space-x-3 bg-white border border-gray-200 rounded-xl py-3 px-4 hover:bg-gray-50 transition-colors duration-200"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center space-x-3 bg-gray-900 text-white rounded-xl py-3 px-4 hover:bg-gray-800 transition-colors duration-200"
            >
